    ...
    p(b, "Extensions/Data.js", [b["Extensions/Ajax.js"], b["Core/Chart/Chart.js"], b["Core/Globals.js"], b["Core/Series/Point.js"], b["Core/Series/SeriesRegistry.js"], b["Core/Utilities.js"]], function (b, p, u, G, H, c) {
        ...
        c = (function () {
            ...
            b.prototype.init = function (a, d, g) {
                ...
                this.hasURLOption(a) && (clearTimeout(this.liveDataTimeout), (k = !1));
            ...
            b.prototype.parseCSV = function (a) {
                function d(a, d, g, e) {
                    ...
                    function h() {
                        f > n || n > O
                            ? (++n, (m = ""))
                            : (!isNaN(parseFloat(m)) && isFinite(m) ? ((m = parseFloat(m)), k("number")) : isNaN(Date.parse(m)) ? k("string") : ((m = m.replace(/\//g, "-")), k("date")),
                              C.length < t + 1 && C.push([]),
                              g || (C[t][d] = m),
                              (m = ""),
                              ++t,
                ...
                function g(a) {
                    ...
                    e = m[";"] > m[","] ? ";" : ",";
                    b.decimalPoint || ((b.decimalPoint = d > g ? "." : ","), (k.decimalRegex = new RegExp("^(-?[0-9]+)" + b.decimalPoint + "([0-9]+)$")));
                    return e;
                }
                function e(a, d) {
                    var e = [],
                            ...
                            for (f = 0; f < l.length; f++)
                                f < e.length &&
                                    ...
                                    l[f] &&
                                        ...
                                        31 < l[f] ? (e[f] = 100 > l[f] ? "YY" : "YYYY") : 12 < l[f] && 31 >= l[f] ? ((e[f] = "dd"), (c = !0)) : e[f].length || (e[f] = "mm")));
                        }
                    if (c) {
            ...
            b.prototype.parseColumn = function (a, d) {
                ...
                for (g[d] || (g[d] = []); b--; ) {
                    ...
                    p || (0 === b && c)
                        ? (a[b] = "" + y)
                        : +u === w
                        ? ((a[b] = w), 31536e6 < w && "float" !== r ? (a.isDatetime = !0) : (a.isNumeric = !0), "undefined" !== typeof a[b + 1] && (q = w > a[b + 1]))
                          ...
                          l && E(n) && "float" !== r
                              ? ((f[b] = m),
                                ...
                                "undefined" !== typeof a[b + 1] &&
                                    ...
                                    m !== q &&
                                        "undefined" !== typeof q &&
                                        (this.alternativeFormat ? ((this.dateFormat = this.alternativeFormat), (b = a.length), (this.alternativeFormat = this.dateFormats[this.dateFormat].alternative)) : (a.unsorted = !0)),
                                    (q = m)))
                              : ((a[b] = "" === y ? null : y), 0 !== b && (a.isDatetime || a.isNumeric) && (a.mixed = !0)));
                }
                l && a.mixed && (e[d] = g[d]);
            ...
            b.prototype.complete = function () {
                ...
                if (c.complete || c.afterComplete) {
                    ...
                    if ("category" === b) for (e = 0; e < h.length; e++) for (f = h[e], n = 0; n < f.readers.length; n++) "x" === f.readers[n].configName && (f.readers[n].configName = "name");
            ...
            b.prototype.update = function (a, b) {
                ...
                a &&
                    ((a.afterComplete = function (a) {
                        a && (a.xAxis && d.xAxis[0] && a.xAxis.type === d.xAxis[0].options.type && delete a.xAxis, d.update(a, b, !0));
                    }),
