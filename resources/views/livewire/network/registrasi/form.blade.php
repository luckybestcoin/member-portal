                            ...
                            <div class="card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2 referral" wire:model.defer="referral">
                                    ...
                                    <div class="card-block">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                ...
                                                <h4 class="m-b-0">{{ number_format($balance, 2) }}</h4>
                                            </div>
                                            <div class="col col-auto text-right">
                                                <i class="fa fa-dollar f-50 text-c-green"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-block">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                ...
                                                <h4 class="m-b-0">{{ number_format($pin) }}</h4>
                                            </div>
                                            <div class="col col-auto text-right">
                        ...
                        <div class="alert alert-warning bg-c-yellow text-white">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <h3 class="text-right"><li class="fa fa-dollar"></li> {{ number_format($left_turnover, 2) }}</h3>
                                </div>
                                <div class="col-sm-6">
                                    <label>Right Side Turnover</label>
                                    <h3 class="text-right"><li class="fa fa-dollar"></li> {{ number_format($right_turnover,2) }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
