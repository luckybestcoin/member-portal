...
class Dashboard extends Component
{
    ...
    public function mount()
    {
        ...
        $this->trx_exchange = TransactionExchange::where('member_id', auth()->id())->where('transaction_exchange_amount')->where('transaction_exchange_type', 'Reward')->get()->sum('transaction_exchange_amount');
